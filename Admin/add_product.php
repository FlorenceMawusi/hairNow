    ...
    <div class="modal-content"> 
      ...
      <div class="modal-body">
        <div class = "login-form" >
            <form id ="form" action = "http://localhost/E-Commerce/HairNow/Actions/add_product.php" method="post" enctype="multipart/form-data">
        ...
        ?>
            ...
            <div class="card shadow rounded mx-auto" style="width: 35rem;">
                ...
                foreach($product_list as $value) {
                    ...
                    <form action = 'http://localhost/E-Commerce/HairNow/Admin/edit_product.php' method = 'post' style = 'display: inline-block;
                    float: right';>
